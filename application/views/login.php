...
<body style="background-image: url('https://cdn.hipwallpaper.com/i/9/98/PKDfnW.jpg'); background-attachment: fixed; background-size: 100% 100%;">
    <div class="container">
        <br />
        <h3 style="text-align:center; font-size:300%;">SMART DUSTBIN SHOP LOGIN PAGE</h3>
        <br />
        <div class="panel panel-default"  style="background-color: #FAEBD7; width:50%;margin-left: 280px;" >
            <div class="panel-heading">Enter Your Data Correctly</div>
            <div class="panel-body">
                ...
                <form method="post" action="<?php echo base_url(); ?>index.php/login/validation">
                    ...
                    <div class="form-group">
                        <input type="submit"  style="background-color: green;" name="login" value="Login" class="btn btn-info" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url(); ?>index.php/register">Register</a>
                    </div>
                </form>
            </div>
        </div>
